...
public class ApnsConfig {
     ...
     */
    private boolean isProEnv = Boolean.TRUE;
    /**
...
//		InputStream is = ApnsConfig.class.getClassLoader().getResourceAsStream(keystore);
        ...
        try {
            bufferedInputStream = new BufferedInputStream(new FileInputStream((String) keystore));
        ...
        setKeyStore(bufferedInputStream);
    }
    ...
    public void setProEnv(boolean isProEnv) {
        this.isProEnv = isProEnv;
    }
